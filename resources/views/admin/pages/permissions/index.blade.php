                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <span class="d-none d-md-block">
                                                    ...
                                                    @can('permission-edit')
                                                        <a href="{{ route('permissions.edit', $permission->uuid) }}" class="btn btn-outline-warning btn-sm">Editar</a>
                                                    @endcan
                                                ...
                                                <div class="dropdown d-block d-md-none">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoesListar">
                                                        <a href="{{ route('permissions.show', $permission->uuid) }}" class="dropdown-item">Visualizar</a>
                                                        @can('permission-edit')
